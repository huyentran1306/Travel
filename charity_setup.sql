-- ================================================
-- 🌟 GIEO NẮNG 2026 - SQL SETUP SCRIPT
...
CREATE POLICY "allow_all_charity_members" ON charity_member_expenses FOR ALL USING (true) WITH CHECK (true);
...
-- BƯỚC 4: INSERT CHI - 2.1 Quà trẻ em

INSERT INTO charity_fund_entries (charity_id, type, category, content, amount, date, status, note) VALUES
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Sữa (30 thùng x 295.000đ)', 8850000, '2026-09-19', 'DONE', '1 thùng = 12 lốc; 1 lốc/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Bánh gấu (354 hộp x 14.500đ)', 5133000, '2026-09-19', 'DONE', '1 hộp/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Kẹo dẻo (350 túi x 4.700đ)', 1645000, '2026-09-19', 'DONE', '1 túi/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Snack (350 bịch x 5.000đ)', 1750000, '2026-09-19', 'DONE', '1 bịch/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Lồng đèn (350 cái x 6.500đ)', 2275000, '2026-09-19', 'DONE', '1 cái/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Đèn nháy (350 cái x 2.800đ)', 980000, '2026-09-19', 'DONE', '1 cái/em'),
('GN2026', 'EXPENSE', 'GIFT_CHILDREN', 'Túi đựng quà (350 cái x 714đ)', 250000, '2026-09-19', 'DONE', '1 túi/em'),
-- 2.2 Ẩm thực
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Ly nhựa (350 cái)', 0, '2026-09-19', 'DONE', 'Lấy từ quỹ còn'),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Ống hút (200 cái)', 30000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Tắc (4 kg x 50.000đ/kg)', 200000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Đường (8 kg x 30.000đ/kg)', 240000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Trà túi lọc (10 hộp x 35.000đ)', 350000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Đá (5 bao x 25.000đ)', 125000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Dưa Hấu (30 kg x 15.000đ/kg)', 450000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'FOOD_STALL', 'Lặt vặt (dao, khăn giấy, băng keo, nước lọc)', 200000, '2026-09-19', 'DONE', NULL),
-- 2.3 Hội chợ
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Vòng ném vòng (10 cái x 4.200đ)', 42000, '2026-09-19', 'DONE', 'Trò: Ném vòng'),
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Chóp ném vòng (5 cái x 13.800đ)', 69000, '2026-09-19', 'DONE', 'Trò: Ném vòng'),
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Bóng ném bóng vào rổ (10 quả x 3.700đ)', 37000, '2026-09-19', 'DONE', 'Trò: Ném bóng vào rổ'),
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Rổ (5 cái x 15.000đ)', 75000, '2026-09-19', 'DONE', 'Trò: Ném bóng vào rổ'),
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Đũa gắp bóng (10 đôi x 1.000đ)', 10000, '2026-09-19', 'DONE', 'Trò: Gắp bóng bằng đũa'),
('GN2026', 'EXPENSE', 'FAIR_GAMES', 'Bóng bàn gắp bằng đũa (10 cái x 2.700đ)', 27000, '2026-09-19', 'DONE', 'Trò: Gắp bóng bằng đũa'),
-- ⚠️ 2.4 GẠCH → KHÔNG INSERT (Gạo 50 bao, Mì 50 thùng)
-- 2.5 Nấu ăn
('GN2026', 'EXPENSE', 'COOKING', 'Nui (20 kg x 30.000đ/kg)', 600000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Sườn heo (30 kg x 120.000đ/kg)', 3600000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Thịt xay (10 kg x 100.000đ/kg)', 1000000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Chả xay (6 kg x 140.000đ/kg)', 840000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Trứng cút (900 quả x 800đ)', 720000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Củ cải, cà rốt (15 kg x 25.000đ/kg)', 375000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Hành ngò, gia vị', 300000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Tô giấy (8 lốc x 35.000đ)', 280000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Muỗng (4 lốc x 15.000đ)', 60000, '2026-09-19', 'DONE', NULL),
('GN2026', 'EXPENSE', 'COOKING', 'Bao tay', 20000, '2026-09-19', 'DONE', NULL),
-- 2.6 Di chuyển
('GN2026', 'EXPENSE', 'TRANSPORT', 'Phụ tiền xe di chuyển / hàng hóa', 5000000, '2026-09-19', 'DONE', NULL);
...
-- BƯỚC 6: VERIFY
SELECT 'TỔNG THU' as loai, SUM(amount) as tong FROM charity_fund_entries WHERE charity_id = 'GN2026' AND type = 'INCOME';
SELECT 'TỔNG CHI' as loai, SUM(amount) as tong FROM charity_fund_entries WHERE charity_id = 'GN2026' AND type = 'EXPENSE';
SELECT category, COUNT(*) so_muc, SUM(amount) tong_chi FROM charity_fund_entries WHERE charity_id = 'GN2026' AND type = 'EXPENSE' GROUP BY category ORDER BY tong_chi DESC;
